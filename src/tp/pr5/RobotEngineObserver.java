 ...
 * in the robot engine. The robot engine will notify the changes in the robot
 * (fuel and recycled material), will inform about communication problems,
 * errors and when the robot wants to say something. Finally, the engine will
 * also notify when the user requests help and when the robot shuts down

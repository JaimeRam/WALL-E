...
/**
 * Exception thrown when a string cannot be parsed to create a command. The
 * exception has a user-friendly message with an explanation about the error.
 * This class has many different constructors, one for every constructor of the
 * base class.
 * 
